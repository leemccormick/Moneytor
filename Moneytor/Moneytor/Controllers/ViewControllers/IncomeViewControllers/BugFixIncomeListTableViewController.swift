//
//  BugFixIncomeListTableViewController.swift
//  Moneytor
//
...
class BugFixIncomeListTableViewController: UITableViewController {
    ...
    func updateFooter(total: Double) {
        ...
        lable.text = "TOTAL Income : \(totalString)  "
...
extension BugFixIncomeListTableViewController {
...
extension BugFixIncomeListTableViewController: UISearchBarDelegate {
